...
class SignIn extends Component {
  ...
  submitForm = (evt) => {
    ...
    if (formIsValid) {
        ...
        firebase.auth().signInWithEmailAndPassword(dataToSubmit.email,dataToSubmit.password).then(() => this.props.history.push('/dashboard')).catch((err) => this.setState({formError:true}))
    }
    else {
      this.setState({
        formError : true
